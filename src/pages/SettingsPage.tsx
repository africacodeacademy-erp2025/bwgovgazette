...
import { LayoutDashboard, Search, Gavel, Heart, Bell, Settings, Menu, X, LogOut, User, ChevronLeft, ChevronRight, Shield, Palette, CreditCard } from "lucide-react";
...
export default function SettingsPage() {
  ...
  return <div className="flex h-screen w-screen bg-gray-50">
      <DashboardSidebar isCollapsed={isCollapsed} setIsCollapsed={setIsCollapsed} isMobileOpen={isMobileOpen} setIsMobileOpen={setIsMobileOpen} userName={displayName} currentPlan={currentPlan} />
                ...
                <Card>
                  ...
                  <CardContent className="space-y-6">
                    <div className="flex items-center justify-between rounded-lg border p-4">
                      ...
                      {subscriptionStatus === 'Active' && <AlertDialog>
                      ...
                      <AlertDialogContent>
                        ...
                        <div className="space-y-4">
                          <div className="space-y-2">
                            ...
                            <Input id="delete-email" type="email" placeholder="Enter your email to confirm" value={deleteEmail} onChange={e => setDeleteEmail(e.target.value)} />
                          </div>
                          <div className="space-y-2">
                            <Label htmlFor="delete-password">Password</Label>
                            <Input id="delete-password" type="password" placeholder="Enter your password to confirm" value={deletePassword} onChange={e => setDeletePassword(e.target.value)} />
                          </div>
                          <div className="space-y-2">
                            <Label htmlFor="delete-comment">Comments (Optional)</Label>
                            <Textarea id="delete-comment" placeholder="Tell us why you are leaving..." value={deleteComment} onChange={e => setDeleteComment(e.target.value)} />
                          </div>
                        </div>
                        <AlertDialogFooter>
                          <AlertDialogCancel>Cancel</AlertDialogCancel>
