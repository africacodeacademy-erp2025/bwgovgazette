          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                {gazettes.map(gazette => <div key={gazette.id} className="flex items-center justify-between p-4 border border-border rounded-lg hover:bg-accent/50 transition-colors">
                    <div className="flex-1">
                      ...
                      <div className="flex items-center space-x-4 text-sm text-muted-foreground">
                        ...
                        <div className="flex items-center space-x-1">
                          ...
                          <span>{gazette.downloads} downloads</span>
                        </div>
                      </div>
                    </div>
                    <div className="flex items-center space-x-2">
